 ...
 *
 */
public class ShadersScene extends SkiaScene {
  ...
  private void drawShaders(Canvas canvas) {
    ...
    Shader[] shaders = new Shader[] { Shader.makeEmpty(), Shader.makeColor(0xFF247ba0),
        ...
        Shader.makeBlend(BlendMode.LIGHTEN, Shader.makeColor(0xFFFF0000), Shader.makeColor(0x9000FF00)), Shader
            .makeLinearGradient(0, 0, 60, 0, new int[] { 0xFF247ba0, 0xFFf3ffbd }).makeWithColorFilter(ColorFilter.makeBlend(0xFFCC3333, BlendMode.SCREEN)), };
  ...
  private void drawGradients(Canvas canvas) {
    ...
    Shader[] shaders = new Shader[] { Shader.makeLinearGradient(0, 0, 60, 0, new int[] { 0xFF247ba0, 0xFFf3ffbd }),
        ...
        Shader.makeLinearGradient(0, 0, 60, 0, new int[] { 0xFF247ba0, 0xFFff1654, 0xFF70c1b3, 0xFFf3ffbd, 0xFFb2dbbf },
            new float[] { 0f, 0.1f, 0.2f, 0.9f, 1f }),
        ...
        Shader.makeSweepGradient(30, 30, new int[] { 0xFF247ba0, 0xFFf3ffbd }), Shader.makeSweepGradient(30, 30, 45, 315,
            new int[] { 0xFF247ba0, 0xFFff1654, 0xFF70c1b3, 0xFFf3ffbd, 0xFFb2dbbf }, null, GradientStyle.DEFAULT.withTileMode(FilterTileMode.DECAL)), };
    ...
    try (Path p1 = new Path().lineTo(30.1f, 0).lineTo(0, 32.5f).closePath();
        Shader s1 = Shader.makeLinearGradient(0, 32.5f, 30.1f, 0, new int[] { 0xFF0095D5, 0xFF3C83DC, 0xFF6D74E1, 0xFF806EE3 },
        ...
        Shader s2 = Shader.makeLinearGradient(0, 60, 60, 0, new int[] { 0xFFC757BC, 0xFFD0609A, 0xFFE1725C, 0xFFEE7E2F, 0xFFF58613, 0xFFF88909 },
        ...
        Shader s3 = Shader.makeLinearGradient(0, 60, 30.1f, 29.9f, new int[] { 0xFF0095D5, 0xFF238AD9, 0xFF557BDE, 0xFF7472E2, 0xFF806EE3 },
  ...
  private void drawLinearCS(Canvas canvas) {
    for (ColorSpace cs : new ColorSpace[] { null, ColorSpace.getSRGB(), ColorSpace.getSRGBLinear() }) {
      ...
      int[][] colors = new int[][] { new int[] { 0xFFFF0000, 0xFF00FF00 }, new int[] { 0xFFFF0000, 0xFF0000FF }, new int[] { 0xFFFF0000, 0xFF00FFFF },
          new int[] { 0xFF0000FF, 0xFF00FF00 }, new int[] { 0xFF00FFFF, 0xFFFF00FF }, new int[] { 0xFF00FF00, 0xFFFF00FF },
          new int[] { 0xFF000000, 0xFFFFFFFF }, new int[] { 0xFF555555, 0xFFAAAAAA }, };
